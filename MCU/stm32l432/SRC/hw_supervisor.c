...
//    Change the desired parameter.
    ...
    RCC->PLLCFGR |= (RCC_PLLCFGR_PLLSRC_HSI << RCC_PLLCFGR_PLLSRC_Pos); //00: No clock sent to PLL PLLSAI1, 01: MSI clock selected as PLL PLLSAI1 clock entry, 10: HSI16 clock selected as PLL PLLSAI1 clock entry, 11: HSE clock selected as PLL PLLSAI1 clock entry
